...
namespace VacationRental.Api.Tests.Apis
{
    ...
    public class GetCalendarTests
    {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            Calendar getCalendarResult =
                await ApiBroker.DeserializeResponseContent<Calendar>(getCalendarResponse);
            ...
            Assert.Contains(getCalendarResult.Dates[1].Bookings, id => id == postBooking1Result.Id);
            ...
            Assert.Contains(getCalendarResult.Dates[2].Bookings, id => id == postBooking1Result.Id);
            Assert.Contains(getCalendarResult.Dates[2].Bookings, id => id == postBooking2Result.Id);

            Assert.Equal(new DateTime(2000, 01, 04), getCalendarResult.Dates[3].Date);
            Assert.Single(getCalendarResult.Dates[3].Bookings);
            Assert.Contains(getCalendarResult.Dates[3].Bookings, id => id == postBooking2Result.Id);
